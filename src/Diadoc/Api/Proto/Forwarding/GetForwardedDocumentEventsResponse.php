...
/**
 * GetForwardedDocumentEventsResponse message
 */
class GetForwardedDocumentEventsResponse extends \ProtobufMessage
{
    ...
    protected static $fields = array(
        ...
        self::EVENTS => array(
            'name' => 'Events',
            'repeated' => true,
            'type' => '\Diadoc\Api\Proto\Forwarding\ForwardedDocumentEvent'
        ),
    );
     ...
     *
     * @param \Diadoc\Api\Proto\Forwarding\ForwardedDocumentEvent $value Value to append
     *
     * @return null
     */
    public function appendEvents(\Diadoc\Api\Proto\Forwarding\ForwardedDocumentEvent $value)
    {
     ...
     * Returns 'Events' list
     *
     * @return \Diadoc\Api\Proto\Forwarding\ForwardedDocumentEvent[]
     */
