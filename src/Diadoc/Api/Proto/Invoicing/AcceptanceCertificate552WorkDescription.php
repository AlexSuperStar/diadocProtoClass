...
/**
 * AcceptanceCertificate552WorkDescription message
 */
class AcceptanceCertificate552WorkDescription extends \ProtobufMessage
{
    ...
    protected static $fields = array(
        ...
        self::ITEMS => array(
            'name' => 'Items',
            'repeated' => true,
            'type' => '\Diadoc\Api\Proto\Invoicing\AcceptanceCertificate552WorkItem'
        ),
    );
     ...
     *
     * @param \Diadoc\Api\Proto\Invoicing\AcceptanceCertificate552WorkItem $value Value to append
     *
     * @return null
     */
    public function appendItems(\Diadoc\Api\Proto\Invoicing\AcceptanceCertificate552WorkItem $value)
    {
     ...
     * Returns 'Items' list
     *
     * @return \Diadoc\Api\Proto\Invoicing\AcceptanceCertificate552WorkItem[]
     */
