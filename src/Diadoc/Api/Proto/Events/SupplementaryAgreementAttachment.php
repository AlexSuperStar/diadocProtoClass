...
/**
 * SupplementaryAgreementAttachment message
 */
class SupplementaryAgreementAttachment extends \ProtobufMessage
{
    ...
    const TOTAL = 9;
    const CONTRACTNUMBER = 10;
    const CONTRACTDATE = 11;
    const CONTRACTTYPE = 12;
    const NEEDRECEIPT = 13;
    const CUSTOMDATA = 14;
