...
/**
 * InboundUniversalTransferDocumentDocflow message
 */
class InboundUniversalTransferDocumentDocflow extends \ProtobufMessage
{
    ...
    const ISREVISED = 7;
    const ISCORRECTED = 8;
    const BUYERTITLEDOCFLOW = 9;
    const RECIPIENTSIGNATUREREJECTIONDOCFLOW = 10;
    const ISRECEIPTREQUESTED = 11;
    const ISRECIPIENTSIGNATUREREQUESTED = 12;
    const ISDOCUMENTSIGNEDBYRECIPIENT = 13;
    const ISDOCUMENTREJECTEDBYRECIPIENT = 14;
    const CANDOCUMENTBERECEIPTED = 15;
    const CANDOCUMENTBESIGNEDORREJECTEDBYRECIPIENT = 16;
    ...
    protected static $fields = array(
        ...
        self::RECEIPTDOCFLOW => array(
            'name' => 'ReceiptDocflow',
            'required' => false,
            'type' => '\Diadoc\Api\Proto\Docflow\InboundInvoiceReceiptDocflow'
        ),
     ...
     *
     * @param \Diadoc\Api\Proto\Docflow\InboundInvoiceReceiptDocflow $value Property value
     *
     * @return null
     */
    public function setReceiptDocflow(\Diadoc\Api\Proto\Docflow\InboundInvoiceReceiptDocflow $value=null)
    {
     ...
     *
     * @return \Diadoc\Api\Proto\Docflow\InboundInvoiceReceiptDocflow
     */
