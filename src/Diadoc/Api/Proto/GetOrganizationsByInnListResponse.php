...
/**
 * GetOrganizationsByInnListResponse message
 */
class GetOrganizationsByInnListResponse extends \ProtobufMessage
{
    ...
    protected static $fields = array(
        self::ORGANIZATIONS => array(
            'name' => 'Organizations',
            'repeated' => true,
            'type' => '\Diadoc\Api\Proto\OrganizationWithCounteragentStatus'
        ),
    );
     ...
     *
     * @param \Diadoc\Api\Proto\OrganizationWithCounteragentStatus $value Value to append
     *
     * @return null
     */
    public function appendOrganizations(\Diadoc\Api\Proto\OrganizationWithCounteragentStatus $value)
    {
     ...
     *
     * @return \Diadoc\Api\Proto\OrganizationWithCounteragentStatus[]
     */
