...
/**
 * UniversalCorrectionDocumentRevisionMetadata message
 */
class UniversalCorrectionDocumentRevisionMetadata extends \ProtobufMessage
{
    ...
    const ORIGINALINVOICECORRECTIONNUMBER = 15;
    const ORIGINALINVOICECORRECTIONDATE = 16;
